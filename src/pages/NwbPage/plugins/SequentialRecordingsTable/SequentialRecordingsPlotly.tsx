...
const SequentialRecordingsPlotly: React.FC<Props> = ({
  ...
  const [appliedDownsampleMethod, setAppliedDownsampleMethod] =
    useState<string>("lttb");
  const [appliedDownsampleFactor, setAppliedDownsampleFactor] =
    useState<number>(10);
    ...
    <div style={{ width, height }}>
      ...
      >
        ...
        {appliedDownsampleFactor > 1 && (
          ...
          >
            ⚠️ The traces below were downsampled for performance, the raw traces
            may be different.
          </div>
        )}
      </div>
